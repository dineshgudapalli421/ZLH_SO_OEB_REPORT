		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OEB Report",
									"targetURL": "#comsaplhcszlhoebreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhcszlhoebreport-display": {
								"semanticObject": "comsaplhcszlhoebreport",
								"action": "display",
								"description": "OEB Report",
								"title": "OEB Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.cs.zlhoebreport",
									"url": sap.ui.require.toUrl("com/sap/lh/cs/zlhoebreport")
								}
							}
						}
					}
